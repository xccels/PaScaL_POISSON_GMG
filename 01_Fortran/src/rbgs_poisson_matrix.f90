...
!$omp parallel do shared(rsd,rhs)
        ...
        if(myrank.eq.0) print '(a,i5,a,e15.7,a,e15.7)','   [RBGS solver] RBGS solver completed. Iteration = ',iter,', mse = ',sqrt(rsd_norm),', r_mse = ',sqrt(rsd_norm/rsd0tol)
...
!$omp parallel do shared(rsd,rhs)
        ...
        if(myrank.eq.0) print '(a,i5,a,e15.7,a,e15.7,a,e15.7)','   [RBGS iterator] RBGS iterator completed. Iteration = ',iter,', mse = ',sqrt(rsd_norm),', r_mse = ',sqrt(rsd_norm/rsd0tol),', rsd0 = ',sqrt(rsd0tol)
